...
The file input.txt contains 1 million integers, both positive and negative (there might be some repetitions!).
...
//
// Note: please refer to input.txt for actual input data ( its too large to fit here )
//
