...
int main()
{
    ...
    cout << "answer: " << fastResult << endl
         << "duration: " << duration_cast< seconds >( fastFinish - fastStart ).count() << " seconds " << endl;
    ...
    cout << "answer: " << slowResult << endl
         << "duration: " << duration_cast< seconds >( slowFinish - slowStart ).count() << " seconds " << endl;
    return 0;
}
